...
class Eagle(tfds.core.GeneratorBasedBuilder):
    ...
    def _generate_examples(self, root_path):
        ...
        hf = h5py.File(
            root_path + "/dataMagnitudes_2000kpc_EMILES_PDXX_DUST_CH_028_z000p000.hdf5",
            "r",
        )
        ...
        for i in range(len(mstar)):
            ...
            try:
                ...
                flux = 10 ** (0.4 * (-app_mag + 8.90))  # convert to Jy
