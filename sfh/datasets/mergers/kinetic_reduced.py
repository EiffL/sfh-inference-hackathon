"""Mergers_kinetic reduced dataset."""
...
_DESCRIPTION = """
#Kinetic reduced data of TNG100 galaxy mergers dataset

This dataset contains a reduced number of examples... For testing puposes.
...
class MergersKineticReduced(tfds.core.GeneratorBasedBuilder):
